...
const Home = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-6 md:py-10 font-arabic px-4 md:px-0">
      ...
      <div className="bg-slate-100/50 rounded-3xl p-8 flex flex-col md:flex-row justify-between items-center gap-6 border border-slate-100">
        ...
        <button className="bg-white text-slate-700 px-6 py-2.5 rounded-xl text-xs font-bold shadow-sm hover:bg-slate-50 transition-all flex items-center gap-2 border border-slate-200">
